    ...
    <div className="relative min-h-screen overflow-hidden bg-[#F8FAFC] text-slate-900 selection:bg-violet-600 selection:text-white">
      ...
      <div className="relative mx-auto flex min-h-screen max-w-7xl items-center justify-center px-4 py-12 sm:px-6 lg:px-8">
        {/* Grid order switched for mobile vs desktop: 
            Desktop: info left (col 1), sign-up right (col 2). 
            Mobile/Tablet: sign-up card appears FIRST, info appears BELOW. */}
        <div className="grid w-full items-center gap-10 lg:grid-cols-[55%_45%]">
          
          {/* Sign Up Card (Order 1 on mobile, Order 2 on desktop) */}
          <motion.div
          ...
          >
            <div className="w-full max-w-[480px] rounded-[36px] border border-violet-100/80 bg-white/90 p-6 sm:p-9 shadow-[0_30px_90px_-28px_rgba(124,58,237,0.35)] backdrop-blur-2xl">
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-xs font-medium text-slate-500">7-Day Free Trial</p>
                  </div>
                </div>
              ...
              <div className="mt-8">
                <h2 className="text-2xl sm:text-3xl font-extrabold tracking-tight text-slate-950">Create Your Account</h2>
              ...
              <form onSubmit={handleSignup} className="mt-7 space-y-4">
                ...
                <motion.button
                  ...
                  type="submit"
                  disabled={loading}
                  className="flex h-[54px] w-full items-center justify-center gap-2 rounded-2xl bg-gradient-to-r from-[#7C3AED] via-[#8B5CF6] to-[#A855F7] font-bold text-sm text-white shadow-lg shadow-violet-600/25 transition-all disabled:cursor-not-allowed disabled:opacity-80 cursor-pointer mt-2"
                >
                  {loading ? (
                    <>
              ...
              <p className="mt-7 text-center text-sm font-medium text-slate-600">
                ...
                <Link to="/login" className="font-bold text-violet-600 transition-colors hover:text-violet-700 underline underline-offset-4 decoration-violet-300">
                  Sign In
                </Link>
              </p>
