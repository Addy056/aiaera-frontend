...
export default function Appointments() {
    ...
    return (
      <div className="min-h-screen flex flex-col items-center justify-center bg-gradient-to-br from-[#03040a] via-[#071026] to-[#020205] text-white p-8">
        ...
        <p className="text-lg text-gray-300 mb-6 text-center">
          Your subscription has expired. Please renew to access Appointments.
        </p>
        <a
          href="/pricing"
          className="px-6 py-3 rounded-2xl bg-gradient-to-r from-[#00eaff]/40 via-[#7afcff]/30 to-[#0077b6]/40 text-white font-semibold hover:scale-105 transition-all"
        >
          Renew Now
        </a>
      </div>
  ...
  return (
    <div className="relative min-h-screen p-4 sm:p-8 overflow-hidden bg-gradient-to-br from-[#03040a] via-[#071026] to-[#020205] text-white">
      {/* Background Glow */}
      ...
      <div className="max-w-7xl mx-auto space-y-6">
        {/* Header */}
        <div className="p-6 sm:p-8 rounded-3xl glass text-white shadow-lg hover:shadow-[0_0_60px_rgba(127,90,240,0.35)] transition-all transform hover:scale-[1.01]">
          ...
          <p className="mt-2 text-gray-300 text-sm sm:text-base">
            Track and manage all scheduled appointments ✨
          </p>
        </div>
        ...
        <div className="flex flex-col sm:flex-row items-center justify-between gap-4">
          <input
            ...
            className="flex-1 p-3 sm:p-4 rounded-2xl glass border-white/20 text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-[#00eaff] shadow-inner transition-all"
          />
          <button
            onClick={exportCSV}
        ...
        {/* Appointments Table */}
        <div className="overflow-x-auto rounded-3xl glass shadow-2xl border border-white/10 hover:shadow-[0_25px_60px_rgba(0,245,255,0.25)] transform hover:scale-[1.01] transition-all text-white">
          {loading ? (
                ...
                {filteredAppointments.map((appt, idx) => (
                  ...
                  >
                    ...
                    <td className="p-3 sm:p-4 break-all">
                      {appt.calendly_event_link ? (
                        <a href={appt.calendly_event_link} target="_blank" rel="noopener noreferrer" className="text-[#00eaff] hover:underline">View Link</a>
                      ) : "—"}
                    </td>
...
function StatCard({ title, value, gradient }) {
  return (
    <div className={`p-5 sm:p-6 rounded-3xl bg-gradient-to-tr ${gradient} border border-white/10 backdrop-blur-xl shadow-lg hover:scale-[1.03] hover:shadow-[0_20px_60px_rgba(0,245,255,0.35)] transition-all text-white`}>
