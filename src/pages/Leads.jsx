...
export default function Leads() {
  ...
  const init = async () => {
    ...
    try {
      ...
      // Free access for specific email
  ...
  const exportCSV = () => {
    ...
    const maxRows = 1000; // optional limit for huge datasets
  ...
  return (
    <div className="relative min-h-screen p-8 overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto space-y-8">
        {/* Header */}
        <div className="p-6 rounded-3xl bg-white/10 backdrop-blur-xl border border-white/20 shadow-[0_0_50px_rgba(127,90,240,0.6)] hover:shadow-[0_0_70px_rgba(127,90,240,0.9)] transition-all transform hover:scale-[1.01] text-white">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-6">
          <div className="p-6 rounded-3xl bg-gradient-to-br from-purple-700/30 to-purple-900/30 border border-purple-500/30 backdrop-blur-lg shadow-xl hover:scale-105 hover:shadow-[0_20px_50px_rgba(127,90,240,0.5)] transition-all transform text-white">
            <h2 className="text-gray-300 text-sm">Total Leads</h2>
            <p className="text-3xl font-bold mt-2">{leads.length}</p>
          </div>
          <div className="p-6 rounded-3xl bg-gradient-to-br from-pink-700/30 to-pink-900/30 border border-pink-500/30 backdrop-blur-lg shadow-xl hover:scale-105 hover:shadow-[0_20px_50px_rgba(236,72,153,0.5)] transition-all transform text-white">
          ...
          <div className="p-6 rounded-3xl bg-gradient-to-br from-blue-700/30 to-blue-900/30 border border-blue-500/30 backdrop-blur-lg shadow-xl hover:scale-105 hover:shadow-[0_20px_50px_rgba(59,130,246,0.5)] transition-all transform text-white">
            <h2 className="text-gray-300 text-sm">Conversion Rate</h2>
        ...
        {/* Leads Table */}
        <div className="overflow-hidden rounded-3xl bg-white/10 backdrop-blur-xl shadow-2xl border border-white/20 hover:shadow-[0_25px_60px_rgba(127,90,240,0.6)] transform hover:scale-[1.01] transition-all text-white">
          {loading ? (
            ...
            <div className="p-8 text-center text-gray-300">No leads yet 🚀</div>
          ) : (
