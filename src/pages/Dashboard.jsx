...
export default function Dashboard() {
  ...
  const fetchKpiAndActivity = async (userId) => {
    try {
      ...
      console.error("❌ KPI/Activity fetch error:", err);
    }
  };
      ...
      case "Get Embed":
        ...
        if (bots && bots.length > 0) {
          const code = bots
            .map(
              (b) =>
                `<script src="https://yourdomain.com/embed/${b.id}.js" async></script>`
            )
            .join("\n");
          setEmbedCode(code);
      ...
      <div className="min-h-screen bg-gradient-to-b from-[#03040a] via-[#071026] to-[#020205] relative text-white">
        ...
        <div className="relative px-4 sm:px-8 pt-8 pb-16 ml-0 md:ml-28">
          ...
          <motion.div
            ...
            className="flex flex-col gap-2 sm:gap-3 mb-10 text-center md:text-left"
          >
            ...
            <p className="text-sm sm:text-base text-gray-300">
              Your AI revenue engine at a glance.
            </p>
          </motion.div>
            ...
            {[
              {
                title: "Chatbots",
                icon: (
                  <ChatBubbleLeftIcon className="w-7 h-7 md:w-9 md:h-9 text-[#00eaff]" />
                ),
                value: `${kpiData.chatbots} Active`,
                sub: "Deployed across Web & WhatsApp",
              ...
              },
              {
                title: "Leads",
                icon: (
                  <UsersIcon className="w-7 h-7 md:w-9 md:h-9 text-[#ffd780]" />
                ),
              ...
              },
              {
                title: "Appointments",
                icon: (
                  <CalendarIcon className="w-7 h-7 md:w-9 md:h-9 text-[#ff6b6b]" />
                ),
              ...
              },
              {
                title: "Conversion",
                icon: (
                  <ArrowTrendingUpIcon className="w-7 h-7 md:w-9 md:h-9 text-[#7afcff]" />
                ),
                value: "12.4%",
                sub: "7-day uplift",
              ...
              <motion.div
                ...
                className={`relative overflow-hidden p-4 sm:p-6 rounded-2xl sm:rounded-3xl bg-gradient-to-tr ${c.accent} border border-white/10 shadow-lg`}
              >
                <div className="absolute inset-0 bg-white/5 blur-2xl pointer-events-none" />
                <div className="relative flex items-center gap-3 sm:gap-4">
                  <div className="shrink-0 rounded-xl sm:rounded-2xl bg-black/30 border border-white/10 p-2 sm:p-3">
                    {c.icon}
                  </div>
          ...
          <div className="grid grid-cols-1 xl:grid-cols-3 gap-4 sm:gap-6 xl:gap-8">
            ...
            <motion.div
              ...
              className="xl:col-span-2 rounded-2xl sm:rounded-3xl border border-white/10 bg-white/5 backdrop-blur-xl p-4 sm:p-6 shadow-lg"
            >
              ...
              <div className="space-y-3 sm:space-y-4">
                {activity.length ? (
                  activity.map((row, idx) => (
                    <div
                      key={idx}
                      className="flex items-start gap-2 sm:gap-3 rounded-xl sm:rounded-2xl border border-white/10 bg-black/20 p-3 sm:p-4 hover:bg-black/25 transition-colors"
                    >
            ...
            <motion.div
              ...
              className="rounded-2xl sm:rounded-3xl border border-white/10 bg-white/5 backdrop-blur-xl p-4 sm:p-6 shadow-lg"
            >
              <h2 className="text-base sm:text-lg md:text-xl font-semibold text-white mb-4">
                Quick Actions
              </h2>
                ...
                {[
                  {
                    ...
                    hint: "Launch a tailored assistant",
                  },
                  {
                    title: "Import FAQs",
                  ...
                  <button
                    ...
                    className="group text-left rounded-xl sm:rounded-2xl p-3 sm:p-4 border border-white/10 bg-black/20 hover:bg-black/30 transition-colors"
                  >
                    <div className="flex items-center gap-2 sm:gap-3 text-white">
                      <span className="rounded-lg sm:rounded-xl bg-white/10 p-2 border border-white/10">
                        {a.icon}
                      </span>
            ...
            <div className="bg-[#020205] rounded-2xl sm:rounded-3xl p-4 sm:p-6 w-full max-w-lg">
              ...
              <div className="flex justify-end mt-4">
                <button
                  ...
                  className="px-4 py-2 bg-[#7f5af0] text-white rounded-lg sm:rounded-xl hover:bg-[#995afc] transition-colors text-sm sm:text-base"
                >
                  Close
                </button>
              </div>
